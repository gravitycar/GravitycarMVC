...
abstract class Singleton
{
   /** @var GravitonLogger the loger object to log messages */
    ...
    {
        $class = get_called_class();
        if (get_called_class() != 'Gravitycar\\lib\\managers\\ErrorManager') {
            $this->errMgr = \Gravitycar\lib\managers\ErrorManager::singleton();
        }
        
        if (get_called_class() != 'Gravitycar\\lib\\managers\\GravitonLogger') {
            $this->log = \Gravitycar\lib\managers\GravitonLogger::singleton();
        }
        
        
        if (get_called_class() != 'Gravitycar\lib\\managers\\ConfigManager') {
