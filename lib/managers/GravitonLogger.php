 ...
 */
class GravitonLogger extends \Gravitycar\lib\abstracts\Singleton
{
    ...
    */
    protected function __construct($prefix = '')
    {
        ...
        if (!is_a($this, 'Gravitycar\lib\managers\ErrorManager')) {
            $this->errMgr = ErrorManager::singleton();
        }
        
        if (!is_a($this, 'Gravitycar\lib\managers\GravitonLogger')) {
    ...
    {
        parent::init();
        $this->logFilePath = $this->cfg->get('root_dir') . '/gravitycar.log';
    }
    ...
    * @return void
    */
    public function debug($msg, $force=true)
    {
    ...
    * @return void
    */
   protected function log($msg, $level, $forceImmediateWrite = true)
   {
